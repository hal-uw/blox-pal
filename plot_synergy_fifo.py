...
main_df = main_df.dropna(subset=['avg_jct_hrs'])

# Plot using seaborn
sns.lineplot(data=df, x='job_load', y='avg_jct_hrs', hue='placement_policy', marker='o',linestyle="--",palette=colors_dict)

plt.legend(loc='upper left')
plt.legend(title='Placement Policy', labels=[placement_labels[policy] for policy in df['placement_policy'].unique()], loc='upper left')
...
# )
plt.savefig(f"{scheduler}-jct-vs-job-load.pdf",
