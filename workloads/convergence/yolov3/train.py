...
class Trainer(object):
    ...
    def train(self):
        ...
        with open(f"../info/yolov3_8.txt", "w"):
            pass
        ...
        for epoch in range(self.start_epoch, self.epochs):
            ...
            for i, (imgs, label_sbbox, label_mbbox, label_lbbox, sbboxes, mbboxes, lbboxes) \
                ...
                # Print batch results
                if i % 10 == 0:
                    s = ('Epoch:[ %d | %d ]    Batch:[ %d | %d ]    loss_giou: %.4f    '
                         'loss_conf: %.4f    loss_cls: %.4f    loss: %.4f    '
            ...
            if epoch >= 20:
                ...
                with open(f"../info/yolov3_8.txt", "a") as file:
