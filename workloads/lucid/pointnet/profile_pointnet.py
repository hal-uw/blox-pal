...
parser.add_argument(
    '--data_dir', type=str, default="shapenetcore/shapenetcore_partanno_segmentation_benchmark_v0/",
    help='Data directory')
...
def benchmark_pointnet(model_name, batch_size, mixed_precision, gpu_id, bench_list):
    t_start = time.time()
    if len(gpu_id) == 1:
...
if __name__ == '__main__':
    ...
    gpu_id = [0, 1, 2, 3]
    bench_list = []
    benchmark_pointnet(model_name, batch_size, mixed_precision, gpu_id, bench_list)
    print(bench_list)
