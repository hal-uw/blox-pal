...
parser.add_argument(
    "--num-batches-per-iter", type=int, default=30,
...
# Training
def benchmark_imagenet(model_name, batch_size, mixed_precision, gpu_id, bench_list):
    t_start = time.time()
    if len(gpu_id) == 1:
...
if __name__ == '__main__':
    ...
    gpu_id = [0, 1, 2, 3]
    bench_list = []
    benchmark_imagenet(model_name, batch_size, mixed_precision, gpu_id, bench_list)
    print(bench_list)
